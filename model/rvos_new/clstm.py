...
class ConvLSTMCell(nn.Module):
    ...
    def forward(self, input_, hidden_state_temporal):
        ...
        prev_hidden_temporal, prev_cell_temporal = hidden_state_temporal


        # data size is [batch, channel, height, width]
        # stacked_inputs = torch.cat([input_, prev_hidden_spatial, hidden_state_temporal], 1)
        stacked_inputs = torch.cat([input_, prev_hidden_temporal], 1)
        ...
        cell = (remember_gate * prev_cell_temporal) + (in_gate * cell_gate)
